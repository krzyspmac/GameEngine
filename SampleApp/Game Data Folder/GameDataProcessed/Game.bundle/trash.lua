...
function loadSprites()	
    ...
    local egaAtlas = AtlasManager:SpriteAtlasLoad("ega.json", "ega.png")

    local egaBackground = scene:SpriteStaticLoad(egaAtlas, "background.png")
    egaBackground:SetScale(3.0)

    local egaSky = scene:SpriteStaticLoad(egaAtlas, "sky.png")
    egaSky:SetScale(2.0)

    local floor = scene:SpriteStaticLoad(egaAtlas, "floor.png")
    floor:SetScale(2.0)

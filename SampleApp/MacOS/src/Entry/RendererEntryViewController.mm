...
//    double x = viewportSize.x;
//    double y = viewportSize.y;
//    MTLViewport viewport = {0.0, 0.0, x, y, 0.0, 1.0};
//    [encoder setViewport:viewport];
//
//    MTL::RenderCommandEncoder *_encoder = (__bridge MTL::RenderCommandEncoder*)encoder;
//
//    // Pass in the parameter data.
//    _encoder->setVertexBytes(triangleVertices, sizeof(triangleVertices), AAPLVertexInputIndexVertices);
//    _encoder->setVertexBytes(&viewportSize, sizeof(viewportSize), AAPLVertexInputIndexViewportSize);
//    _encoder->drawPrimitives(MTL::PrimitiveTypeTriangle, (NS::UInteger)0, (NS::UInteger)3);

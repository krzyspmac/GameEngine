...
LightMetal::LightMetal(LightFalloutType type, Color3 color, float ambientIntensity, Origin position, float diffuseSize, float diffuseIntensity)
    : Light(type, color, ambientIntensity, position, diffuseSize, diffuseIntensity)
{
